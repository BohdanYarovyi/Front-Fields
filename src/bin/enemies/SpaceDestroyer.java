...
import bin.gameComponents.LaserGun;
...
public class SpaceDestroyer extends Enemy{
    ...
    public SpaceDestroyer(int x,
        ...
        this.point = 20;
        this.imageWithoutFilter = new ImageIcon("src/bin/image/persons/enemy/spaceDestroyer.png").getImage();
        this.imageRedFilter = new ImageIcon("src/bin/image/persons/enemy/spaceDestroyer_red.png").getImage();
