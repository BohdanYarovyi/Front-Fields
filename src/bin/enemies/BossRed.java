...
public class BossRed extends Enemy{
    ...
    public BossRed(int x,
        ...
        this.point = 70;
        this.imageWithoutFilter = new ImageIcon("src/bin/image/persons/enemy/boss.png").getImage();
        this.imageRedFilter = new ImageIcon("src/bin/image/persons/enemy/boss_red.png").getImage();
