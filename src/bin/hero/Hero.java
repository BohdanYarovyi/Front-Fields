...
public class Hero implements KeyListener {
    ...
    public Image imagePNG = new ImageIcon("src/bin/image/persons/hero/hero1.png").getImage();
...
//        showHitBox(g);
    ...
    public void rechargeGun(GameScene gc){  //тут я міг би повертати
                                            //boolean і не створювати допоміжних змінних
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (key == KeyEvent.VK_A) {
            ...
            imagePNG = new ImageIcon("src/bin/image/persons/hero/hero1_left.png").getImage();
        }
        if (key == KeyEvent.VK_D) {
            heroDirection = Direction.RIGHT;
            imagePNG = new ImageIcon("src/bin/image/persons/hero/hero1_right.png").getImage();
        }
    }
    ...
    public void keyReleased(KeyEvent e) {
        ...
        imagePNG = new ImageIcon("src/bin/image/persons/hero/hero1.png").getImage();
    }
